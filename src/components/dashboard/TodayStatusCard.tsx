...
export const TodayStatusCard = ({
  ...
  const stats = [
    ...
    { label: "Day streak", value: 3, Icon: Flame }, // ✅ fixed realistic value
    { label: "Attendance %", value: "78%", Icon: CalendarCheck }, // ✅ NEW COLUMN
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h2
          id="today-heading"
          className="font-display text-2xl md:text-4xl font-bold text-primary-foreground mt-1"
        >
